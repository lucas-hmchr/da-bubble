...
export const avatars: readonly Avatar[] = [
    ...
    { id: 'avatar_male_2', src: '/images/avatars/avatar_female_1.svg'},
    { id: 'avatar_male_3', src: '/images/avatars/avatar_female_2.svg'},
    { id: 'avatar_male_4', src: '/images/avatars/avatar_male_1.svg'},
]
